...
class PaiControllerCfg(LeggedRobotCfg):
    ...
    class init_state(LeggedRobotCfg.init_state):
        ...
        dof_pos_range = {
            'r_hip_yaw_joint': [-0.6, 0.6],
            'r_hip_roll_joint': [-0.4, 0.22],
            'r_thigh_joint': [-2.25, -0.4],
            'r_calf_joint': [0.0, 2.37],
            'r_ankle_joint': [-0.83, 0.59],
            'l_hip_yaw_joint': [-0.6, 0.6],
            'l_hip_roll_joint': [-0.22, 0.4],
            'l_thigh_joint': [-2.25, 0.4],
            'l_calf_joint': [0.0, 2.37],
            'l_ankle_joint': [-0.83, 0.59],
        }
    ...
    class commands(LeggedRobotCfg.commands):
        ...
        class ranges(LeggedRobotCfg.commands.ranges):
            ...
            lin_vel_x = [-0.8, 0.8] # [-3.0, 3.0] # min max [m/s]
            lin_vel_y = 0.4 # 1.5   # min max [m/s]
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/livelybot_urdf/urdf/pai_2_10_240723_rl.urdf'
        keypoints = ["base_link"]
        end_effectors = ['r_ankle', 'l_ankle']
        foot_name = 'ankle'
...
class PaiControllerRunnerCfg(LeggedRobotRunnerCfg):
    do_wandb = True
    seed = -1
    ...
    class runner(LeggedRobotRunnerCfg.runner):
        ...
        run_name = 'sf'
        experiment_name = 'Pai_Controller'
        save_interval = 100
