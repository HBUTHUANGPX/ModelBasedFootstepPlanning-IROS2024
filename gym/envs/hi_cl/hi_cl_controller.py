...
from gym.envs.hi_cl.hi_cl_controller_config import HiclControllerCfg
from gym.utils.math import *
from gym.envs import LeggedRobot
from isaacgym import gymapi, gymutil
import numpy as np
from typing import Tuple, Dict
from .hi_cl_utils import (
    FootStepGeometry,
    SimpleLineGeometry,
    VelCommandGeometry,
    smart_sort,
...
class HiclController(LeggedRobot):
    cfg: HiclControllerCfg
