...
from gym.envs.pai02.pai02_controller_config import Pai02ControllerCfg
from gym.utils.math import *
from gym.envs import LeggedRobot
from isaacgym import gymapi, gymutil
import numpy as np
from typing import Tuple, Dict
from .pai02_utils import (
    FootStepGeometry,
    SimpleLineGeometry,
    VelCommandGeometry,
    smart_sort,
...
class Pai02Controller(LeggedRobot):
    cfg: Pai02ControllerCfg
    ...
    def _init_buffers(self):
        ...
        self.right_hip_pos = self.rigid_body_state[
            :, self.rigid_body_idx["r_hip_yaw_link"], :3
        ]
        self.left_hip_pos = self.rigid_body_state[
            :, self.rigid_body_idx["l_hip_yaw_link"], :3
        ]
    ...
    def _compute_torques(self):
        ...
        if self.cfg.asset.apply_humanoid_jacobian:
            ...
            # print(self._compute_torques.__qualname__)
    ...
    def _update_commands(self):
        ...
        print("2: ",update_step_commands_mask)
        ...
        print("3: ",update_step_commands_mask)
        ...
        # print(self.step_commands[0,0],self.step_commands[0,1])
    ...
    def _generate_step_command_by_3DLIPM_XCoM(self, update_commands_ids):
        ...
        print(random_step_command)
        return random_step_command

    def _update_LIPM_CoM(self, update_commands_ids):
        '''
        该函数的计算步骤在_generate_step_command_by_3DLIPM_XCoM中都有实现，
        而最后的计算结果self.LIPM_CoM并没有用到
        '''
