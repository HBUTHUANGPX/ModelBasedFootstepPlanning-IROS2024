...
class Pai02ControllerCfg(LeggedRobotCfg):
...
class Pai02ControllerRunnerCfg(LeggedRobotRunnerCfg):
    do_wandb = True
    seed = -1
    ...
    class runner(LeggedRobotRunnerCfg.runner):
        ...
        max_iterations = 5000
        run_name = 'sf'
        experiment_name = 'Pai02_Controller'
        save_interval = 100
