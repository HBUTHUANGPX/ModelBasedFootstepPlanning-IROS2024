"""
Environment file for "fixed arm" (FA) Pai02 environment
...
class Pai02Vanilla(LeggedRobot):
    ...
    def _compute_torques(self):
        ...
        if (self.cfg.asset.apply_Pai02_jacobian):
    ...
    def _draw_velocity_arrow_vis(self):
        """ Draws linear / angular velocity arrow for Pai02 
