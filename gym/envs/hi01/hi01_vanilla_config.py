"""
Configuration file for "fixed arm" (FA) Hi01 environment
...
class Hi01VanillaCfg(LeggedRobotCfg):
...
class Hi01VanillaRunnerCfg(LeggedRobotRunnerCfg):
    do_wandb = True
    seed = -1
