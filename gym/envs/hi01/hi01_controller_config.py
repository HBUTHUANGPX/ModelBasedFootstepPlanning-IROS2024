...
class Hi01ControllerCfg(LeggedRobotCfg):
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/hi_18/urdf/hi_1_18_240815_rl.urdf'
        keypoints = ["base_link"]
...
class Hi01ControllerRunnerCfg(LeggedRobotRunnerCfg):
    do_wandb = True
    seed = -1
    ...
    class runner(LeggedRobotRunnerCfg.runner):
        ...
        max_iterations = 5000
        run_name = 'sf'
        experiment_name = 'Hi01_Controller'
        save_interval = 100
